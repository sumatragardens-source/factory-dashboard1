...
{#if unacked.length > 0}
	<div class="space-y-2">
		...
		{#each medium as alert}
			<div
				class="flex items-center gap-2 p-3 rounded-lg border bg-amber-900/20 border-amber-500/30 text-amber-400 text-sm"
			>
		...
		{#each low as alert}
			<div
				class="flex items-center gap-2 p-3 rounded-lg border bg-blue-900/20 border-blue-500/30 text-blue-400 text-sm"
			>

...
export const UNIT_RATES = {
	...
	dLimonene: { name: 'D-Limonene', unit: 'L', rate: 13.0, notes: 'Food grade' },
	aceticAcid: { name: 'Acetic acid (glacial)', unit: 'L', rate: 0.5, notes: 'SE Asia market' },
	naoh: { name: 'NaOH flakes (lye)', unit: 'kg', rate: 0.4, notes: 'Asia $290-400/MT' },
	k2co3: { name: 'K₂CO₃ (potassium carbonate)', unit: 'kg', rate: 1.5, notes: 'SE Asia $924/MT' },
	testing: {
		name: 'Testing (per lot)',
		unit: 'lot',
		rate: 110.0,
		notes: '$110/ton, allocated per lot (÷10 for per-batch)'
	},
	...
	shipping: { name: 'Shipping (finished product)', unit: 'kg', rate: 80.0, notes: 'International' }
} as const;

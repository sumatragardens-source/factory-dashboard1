	...
	<div class="bg-bg-card border border-border-card pt-3 pl-3 pb-3 pr-1 rounded w-full flex-1 flex flex-col min-h-0">
		...
		<div class="flex items-center gap-2 mb-3 pb-2 border-b border-border-subtle pr-3">
			<div class="flex items-center gap-1 flex-none overflow-x-auto min-w-0">
				{#each allLots() as lot}
					<button onclick={() => selectedLot = lot} class="px-1.5 py-0.5 text-xs font-bold uppercase tracking-wider rounded transition-colors {activeLot === lot ? 'text-primary bg-primary/15' : 'text-text-muted/40 hover:text-text-muted/60'}">{lot}</button>
				{/each}
			</div>
		...
		{#if carouselIndex === 0}
			{#if costMode === 'lot'}
				...
				<div class="flex gap-1.5 mb-2 overflow-x-auto">
					<div class="flex-1 min-w-[120px] bg-bg-card border border-white/10 rounded p-2 flex flex-col gap-0.5">
			...
			{:else if costMode === 'batch'}
				...
				<div class="mb-1">
					...
					<div class="flex gap-2">
						...
						<button class="flex-1 bg-bg-card border border-white/10 rounded p-1.5 text-left hover:bg-white/5 transition-colors" onclick={() => { selectedLot = bestLotH; costMode = 'lot'; }}>
						...
						<button class="flex-1 bg-bg-card border border-white/10 rounded p-1.5 text-left hover:bg-white/5 transition-colors" onclick={() => { selectedLot = worstLotH; costMode = 'lot'; }}>
			...
			{:else if ethanolMode === 'batch'}
				...
				<div class="mb-2">
					...
					<div class="flex gap-2">
						...
						<button class="flex-1 bg-bg-card border border-white/10 rounded p-1.5 text-left hover:bg-white/5 transition-colors" onclick={() => { selectedLot = bestEthLot; ethanolMode = 'lot'; }}>
							<span class="text-[11px] font-bold uppercase tracking-widest" style="color: #bef264;">Best</span>
						...
						<button class="flex-1 bg-bg-card border border-white/10 rounded p-1.5 text-left hover:bg-white/5 transition-colors" onclick={() => { selectedLot = worstEthLot; ethanolMode = 'lot'; }}>
							<span class="text-[11px] font-bold uppercase tracking-widest" style="color: #ef4444;">Worst</span>
			...
			{:else if yieldMode === 'batch'}
				...
				<div class="mb-2">
					...
					<div class="flex gap-2">
						...
						<button class="flex-1 bg-bg-card border border-white/10 rounded p-1.5 text-left hover:bg-white/5 transition-colors" onclick={() => { selectedLot = bestYieldLot; yieldMode = 'lot'; }}>
							<span class="text-[11px] font-bold uppercase tracking-widest" style="color: #bef264;">Best</span>
						...
						<button class="flex-1 bg-bg-card border border-white/10 rounded p-1.5 text-left hover:bg-white/5 transition-colors" onclick={() => { selectedLot = worstYieldLot; yieldMode = 'lot'; }}>
							<span class="text-[11px] font-bold uppercase tracking-widest" style="color: #ef4444;">Worst</span>
		...
		<div class="grid grid-cols-6 gap-3">
			{#each data.materials ?? [] as mat}
				...
				{#if cfg}
					...
					<div class="bg-bg-card border border-border-card rounded p-3 {mat.on_hand_qty <= cfg.threshold ? 'border-red-500/30' : ''}">
